...
For detailed setup instructions, including prerequisites, installation, environment configuration, database setup, and running the project, see [CONTRIBUTING.md](CONTRIBUTING.md).
